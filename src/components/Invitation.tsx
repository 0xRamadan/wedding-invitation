  ...
  return (
    <div className="min-h-screen w-full relative pb-24 overflow-hidden flex flex-col items-center bg-transparent font-serif text-brand-primary">
      ...
      <div className="max-w-4xl w-full px-6 pt-16 sm:pt-24 flex flex-col items-center text-center z-10">
        ...
        >
          <span className="absolute text-[80px] sm:text-[130px] font-sans font-black text-brand-faint -z-10 opacity-60 uppercase tracking-tighter pointer-events-none select-none">
            RSVP
          </span>
          ...
          <p className="font-arabic text-sm text-brand-secondary max-w-sm mx-auto mb-8 font-medium">
            سعادتنا تكتمل بوجودكم، أكدوا حضوركم لحفل خطوبتنا
          </p>
          ...
          <motion.button
            ...
            className="flex items-center gap-3 px-10 py-4 bg-brand-primary text-brand-bg text-[11px] uppercase tracking-[0.3em] font-sans font-bold hover:bg-brand-accent transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer border-none rounded-full"
          >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
          className="w-full relative text-center flex flex-col items-center mb-24"
          dir="rtl"
        >
          ...
          {/* Map */}
          <div className="w-full max-w-2xl h-80 bg-brand-bg relative mb-12 border border-brand-border overflow-hidden rounded-2xl">
             {/* Map overlays */}
